...
public class juego {
    ...
    public static String sistema(char[][] tablero, int[][] matrizTestigo, int[][] cantJugadasTateti, int jugador){
        ...
        while(enJuego) {
            ...
            // Verifica si el tablero esta lleno, de estarlo da la opcion de elegir otro al jugador.
    ...
    public static char[][] jugadas (char[][] tablero, int[] jugada, int jugador){
        ...
        // Valores  Par --> Jugador 1 || Impar --> Jugador 2
        char valor ='X';
        if(jugador %2 != 0){
            valor = 'O';
        }        
